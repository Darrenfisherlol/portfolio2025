...
export default function Header(){
    ...
    return(
        <header className="HeaderBox" id="HeaderBox">
            <h2 className="HeaderLeft">Darren Fisher</h2>
            <nav className="HeaderRight">
                ...
                {/* <a href="https://www.linkedin.com/in/darrenafisher/" target="_blank">
                    <svg width="25px" height="25px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
